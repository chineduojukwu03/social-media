...
import { Modal, Grid, Image, Icon, Card, Divider } from 'semantic-ui-react'
...
function ImagineModal({ post, user, setLikes, likes, isLiked, comments, setComments }) {
    return (
        <>
                    ...
                    <Card fluid>
                        ...
                        <Card.Content extra>
                            ...
                            <div
                                style={{
                                    overflow: 'auto',
                                    height: comments.length > 0 ? '200px' : '60px',
                                    marginBottom: '8px'
                                }}>
                                {comments.length > 0 && (
